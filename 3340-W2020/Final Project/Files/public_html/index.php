		...
		<div class="content">
			<div class="content_message">
				...
				<p>					We offer a new and innovative way to share files. By bring millions of users together world wide, <br> we create a database of files and give each user 
					the opportunity to add and benefit from everyone's knowledge.<br><a href="createdb.php">create database and tables</a><br>
									<img src="img/files.png" alt="File Image" width="25%" height="25%" >
									</p>
				<p></p>
